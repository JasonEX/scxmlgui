...
public class SCXMLFileChoser extends JFileChooser {
	...
	public SCXMLFileChoser(SCXMLGraphEditor editor, String lastDir, File file) {
		...
		String wd = (lastDir != null) ? lastDir
				: ((editor.getCurrentFile() != null) ? editor.getCurrentFile()
						.getParent()
	...
	public static class FileChoserCustomControls extends JPanel implements
			ItemListener {
		...
		public FileChoserCustomControls(SCXMLGraphEditor editor) {
			...
			this.editor = editor;
			boolean ignoreStoredLayout = editor.preferences.getBoolean(
					PREFERENCE_IGNORE_STORED_LAYOUT, true);
		...
		public void itemStateChanged(ItemEvent e) {
			editor.preferences.putBoolean(PREFERENCE_IGNORE_STORED_LAYOUT,
