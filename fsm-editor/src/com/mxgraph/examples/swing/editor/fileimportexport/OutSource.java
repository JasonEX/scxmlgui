...
public class OutSource implements Serializable {
	...
	public boolean equals(Object obj) {
		if (obj instanceof OutSource) {
			...
			return (obj != null
					&& ((objOutSource.location != null && objOutSource.location
							.equals(location)) || (objOutSource.location == null)) && ((objOutSource.type != null && objOutSource.type
					.equals(type)) || (objOutSource.type == null)));
		} else
